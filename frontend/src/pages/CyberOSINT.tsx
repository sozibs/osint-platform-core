...
const CyberOSINT: React.FC = () => {
  const [query, setQuery] = useState('');

  return (
    <div>
      <h1 style={{ marginBottom: 24, fontSize: 22 }}>Cyber OSINT</h1>
      <div className="card" style={{ marginBottom: 16 }}>
        <label style={{ display: 'block', marginBottom: 8, color: '#8892b0', fontSize: 13 }}>
          IP address, domain, or hash
        </label>
      ...
      <div className="card">
        <p style={{ color: '#8892b0', fontSize: 14 }}>Threat intelligence results will appear here.</p>
      </div>
    </div>
  );
};

export default CyberOSINT;
